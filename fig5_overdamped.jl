...
rate_idx = 3 # Currently including 1, 3 and 6 in the figure.
a4s = [1.73  2.36  2.45  3.06  3.08  3.52] # Found using 'hco_pendulum.jl'.
k3s = [0.7  0.8  0.9  1.0  1.1  1.2]

a2 = 1.6;  a3 = k3s[rate_idx]*1.5;  a4 = a4s[rate_idx]
gsyn_val = -0.04
